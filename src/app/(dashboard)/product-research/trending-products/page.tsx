...
const CATEGORIES = [
  { id: "12165089031", name: "Amazon Launchpad", icon: "🚀" },
  { id: "13919934031", name: "Amazon Renewed", icon: "♻️" },
  { id: "2470603031", name: "Apps & Games", icon: "📱" },
  { id: "1571273031", name: "Baby Products", icon: "👶" },
  { id: "1983398031", name: "Bags, Wallets and Luggage", icon: "🎒" },
  { id: "1350384031", name: "Beauty", icon: "💄" },
  ...
  { id: "4141076031", name: "Garden & Outdoors", icon: "🌱" },
  { id: "3704982031", name: "Gift Cards", icon: "🎁" },
  { id: "2454178031", name: "Grocery & Gourmet Foods", icon: "🛒" },
  { id: "1374527031", name: "Health & Personal Care", icon: "⚕️" },
  { id: "976442031", name: "Home & Kitchen", icon: "🏠" },
  { id: "3419918031", name: "Home Improvement", icon: "🔨" },
  { id: "3419919031", name: "Industrial & Scientific", icon: "🔬" },
  { id: "1951048031", name: "Jewellery", icon: "💎" },
  { id: "1571277031", name: "Kindle Store", icon: "📖" },
  { id: "1571280031", name: "Movies & TV Shows", icon: "🎬" },
  { id: "1571281031", name: "Music", icon: "🎵" },
  { id: "1375424031", name: "Musical Instruments", icon: "🎸" },
  { id: "4149454031", name: "Office Products", icon: "📎" },
  { id: "4141094031", name: "Pet Supplies", icon: "🐾" },
  { id: "1571283031", name: "Shoes & Handbags", icon: "👠" },
  { id: "1464871031", name: "Software", icon: "💾" },
  { id: "1983396031", name: "Sports, Fitness & Outdoors", icon: "🏃" },
  { id: "2061109031", name: "Toys & Games", icon: "🧸" },
  { id: "976426031", name: "Video Games", icon: "🎮" },
  { id: "1350387031", name: "Watches", icon: "⌚" },
];
