...
const CATEGORY_NODES: Record<string, { nodeId: string; name: string }> = {
  "12165089031": { nodeId: "12165089031", name: "Amazon Launchpad" },
  "13919934031": { nodeId: "13919934031", name: "Amazon Renewed" },
  "2470603031": { nodeId: "2470603031", name: "Apps & Games" },
  "1571273031": { nodeId: "1571273031", name: "Baby Products" },
  "1983398031": { nodeId: "1983398031", name: "Bags, Wallets and Luggage" },
  "1350384031": { nodeId: "1350384031", name: "Beauty" },
  ...
  "4141076031": { nodeId: "4141076031", name: "Garden & Outdoors" },
  "3704982031": { nodeId: "3704982031", name: "Gift Cards" },
  "2454178031": { nodeId: "2454178031", name: "Grocery & Gourmet Foods" },
  "1374527031": { nodeId: "1374527031", name: "Health & Personal Care" },
  "976442031": { nodeId: "976442031", name: "Home & Kitchen" },
  "3419918031": { nodeId: "3419918031", name: "Home Improvement" },
  "3419919031": { nodeId: "3419919031", name: "Industrial & Scientific" },
  "1951048031": { nodeId: "1951048031", name: "Jewellery" },
  "1571277031": { nodeId: "1571277031", name: "Kindle Store" },
  "1571280031": { nodeId: "1571280031", name: "Movies & TV Shows" },
  "1571281031": { nodeId: "1571281031", name: "Music" },
  "1375424031": { nodeId: "1375424031", name: "Musical Instruments" },
  "4149454031": { nodeId: "4149454031", name: "Office Products" },
  "4141094031": { nodeId: "4141094031", name: "Pet Supplies" },
  "1571283031": { nodeId: "1571283031", name: "Shoes & Handbags" },
  "1464871031": { nodeId: "1464871031", name: "Software" },
  "1983396031": { nodeId: "1983396031", name: "Sports, Fitness & Outdoors" },
  "2061109031": { nodeId: "2061109031", name: "Toys & Games" },
  "976426031": { nodeId: "976426031", name: "Video Games" },
  "1350387031": { nodeId: "1350387031", name: "Watches" },
};
